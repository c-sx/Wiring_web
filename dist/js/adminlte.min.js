...
!function (t, e) {
  ...
  var e = function (t) {
    ...
    var e = "Layout", i = t.fn[e], n = ".main-header", s = ".main-sidebar", o = ".main-sidebar .sidebar",
      a = ".content-wrapper", r = ".main-footer", l = ".login-box", c = ".register-box", d = "sidebar-focused",
      h = "layout-fixed", f = "login-page", u = "register-page",
      g = {scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l"}, _ = function () {
        function e(t, e) {
        ...
        return i.fixLayoutHeight = function () {
          ...
          i == e.window ? t(a).css("min-height", i - e.header - e.footer) : t(a).css("min-height", i - e.header), t("body").hasClass(h) && (t(a).css("min-height", i - e.header - e.footer), "undefined" != typeof t.fn.overlayScrollbars && t(o).overlayScrollbars({
            className: this._config.scrollbarTheme,
            sizeAutoCapable: !0,
            scrollbars: {autoHide: this._config.scrollbarAutoHide, clickScrolling: !0}
          }))
          ...
          var e = this;
          if (this.fixLayoutHeight(), t(o).on("collapsed.lte.treeview expanded.lte.treeview collapsed.lte.pushmenu expanded.lte.pushmenu", (function () {
            e.fixLayoutHeight()
          ...
          return this.each((function () {
            var n = t(this).data("lte.layout"), s = t.extend({}, g, t(this).data());
    ...
    var e = "PushMenu", i = ".lte.pushmenu", n = t.fn[e], s = {COLLAPSED: "collapsed" + i, SHOWN: "shown" + i},
      o = {autoCollapseSize: 992, enableRemember: !1, noTransitionAfterReload: !0}, a = {
        ...
        return n.show = function () {
          ...
          this._options.autoCollapseSize && (t(window).width() <= this._options.autoCollapseSize ? t(a.BODY).hasClass(l) || this.collapse() : t(a.BODY).hasClass(l) ? t(a.BODY).removeClass(l) : this.show())
        }, n.remember = function () {
